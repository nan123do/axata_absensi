...
class Paket {
  ...
  Paket.fromOnlineJson(Map<String, dynamic> json) {
    id = json['id'];
    keterangan = json['keterangan'];
    nama = json['nama'];
    harga = double.parse(json['harga']);
...
class DataRegistrasiModel {
  ...
  DataRegistrasiModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    // tenant = Tenant.fromJson(json['tenant']);
    paket = Paket.fromJson(json['aa_paket']);
    idPaket = json['idpaket'];
  ...
  DataRegistrasiModel.fromOnlineJson(Map<String, dynamic> json) {
    id = json['id'];
    tenant = Tenant.fromJson(json['tenant']);
    paket = Paket.fromOnlineJson(json['paket']);

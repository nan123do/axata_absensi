...
import 'package:axata_absensi/pages/register/controllers/register_controller.dart';
...
class RegisterView extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Daftar'),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    titleField('Nama Perusahaan', true),
                    Container(
                      padding: EdgeInsets.symmetric(
                        horizontal: 30.w,
                        vertical: 24.h,
                    ...
                    AxataTheme.styleJarak12,
                    titleField('Alamat Perusahaan', true),
                    Container(
                      padding: EdgeInsets.symmetric(
                        horizontal: 30.w,
                        vertical: 24.h,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        titleField('Username Admin', true),
                        Container(
                          padding: EdgeInsets.symmetric(
                            horizontal: 30.w,
                            vertical: 24.h,

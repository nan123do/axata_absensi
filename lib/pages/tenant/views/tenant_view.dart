...
class TenantView extends GetView<TenantController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Penyewa'),
            ...
            : Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      'Total : ${controller.listTenant.length} Pegawai',
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemCount: controller.listTenant.length,
                      itemBuilder: (context, index) {
                        final data = controller.listTenant[index];
